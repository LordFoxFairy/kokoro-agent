...
_YAML_TO_ENV: dict[str, str] = {
    ...
    "model.local_fake_script": "KOKORO_LOCAL_FAKE_SCRIPT",
    ...
    "media.rpc_url": "KOKORO_MEDIA_RPC_URL",
    "media.ca_file": "KOKORO_MEDIA_RPC_CA_FILE",
    "media.cert_file": "KOKORO_MEDIA_RPC_CERT_FILE",
    "media.key_file": "KOKORO_MEDIA_RPC_KEY_FILE",
    "media.timeout_ms": "KOKORO_MEDIA_RPC_TIMEOUT_MS",
    ...
    "assets.config": "KOKORO_ASSETS_CONFIG",
