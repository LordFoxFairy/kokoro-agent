...
INTERACTION_V2_ACTIVATION_BLOCKERS: tuple[str, ...] = (
    ...
    "Root-equivalent CEL/protovalidate runtime is not wired at protobuf boundaries",
    "Root decision_group_ref identity helper and ordered-frame proof are not frozen/generated",
    "Successor proof authority is not wired; repository rejects every revision above one",
    "Hermetic protoc toolchain artifact is not pinned; explicit 33.4 regeneration is only a drift gate",
