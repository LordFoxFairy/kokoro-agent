"""Connect adapter for the Root PresentationService V1 delivery boundary."""
...
def _validate_command(command: common_wire.CommandIdentityV2) -> None:
    if (
        not re.fullmatch(r"[0-9a-f]{32}", command.command_id)
    ...
    async def acknowledge_admissions(
        ...
        try:
            ...
            if (
                ...
                != effect.receipts[-1].delivery_seq
    ...
    async def quarantine_submission(
        ...
        try:
            ...
            if (
                ...
                or effect.effect_digest
                != effect_digest(effect, QUARANTINE_EFFECT_DOMAIN)
                or effect.expected_status_revision < 1
