...
def test_scripted_builds_a_runnable_agent(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_real_spec_builds_without_network(monkeypatch: pytest.MonkeyPatch) -> None:
